...
#include "simple_drive_control/srv/detail/driving_maneuver__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const simple_drive_control::srv::DrivingManeuver_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<simple_drive_control::srv::DrivingManeuver_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DrivingManeuver_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const simple_drive_control::srv::DrivingManeuver_Request *>(
...
static size_t _DrivingManeuver_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DrivingManeuver_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DrivingManeuver_Request__callbacks = {
...
static rosidl_message_type_support_t _DrivingManeuver_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DrivingManeuver_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_simple_drive_control
const rosidl_message_type_support_t *
get_message_type_support_handle<simple_drive_control::srv::DrivingManeuver_Request>()
{
  return &simple_drive_control::srv::typesupport_fastrtps_cpp::_DrivingManeuver_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const simple_drive_control::srv::DrivingManeuver_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<simple_drive_control::srv::DrivingManeuver_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DrivingManeuver_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const simple_drive_control::srv::DrivingManeuver_Response *>(
...
static size_t _DrivingManeuver_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DrivingManeuver_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DrivingManeuver_Response__callbacks = {
  "simple_drive_control::srv",
...
static rosidl_message_type_support_t _DrivingManeuver_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DrivingManeuver_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &simple_drive_control::srv::typesupport_fastrtps_cpp::_DrivingManeuver_Response__handle;
}
...
static service_type_support_callbacks_t _DrivingManeuver__callbacks = {
  "simple_drive_control::srv",
  "DrivingManeuver",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_drive_control, srv, DrivingManeuver_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, simple_drive_control, srv, DrivingManeuver_Response)(),
...
static rosidl_service_type_support_t _DrivingManeuver__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DrivingManeuver__callbacks,
...
{
  return &simple_drive_control::srv::typesupport_fastrtps_cpp::_DrivingManeuver__handle;
}
